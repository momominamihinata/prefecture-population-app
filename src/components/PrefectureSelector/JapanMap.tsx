...
const JapanMap: React.FC<JapanMapProps> = ({ onPrefectureClick, isPrefectureSelected }) => {
  ...
  >
    <g className="svg-map" transform="matrix(1.028807, 0, 0, 1.028807, -47.544239, -28.806583)">
      ...
      <g onClick={() => onPrefectureClick(46, '鹿児島')} fill={isPrefectureSelected(46) ? '#3B82F6' : '#EEE'}  data-code={46} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(96.000000, 17.000000)">
        <title>
          鹿児島 / Kagoshima
        </title>
      ...
      <g onClick={() => onPrefectureClick(45, '宮崎')} fill={isPrefectureSelected(45) ? '#3B82F6' : '#EEE'} data-code={45} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(152.000000, 824.000000)">
        <title>
          宮崎 / Miyazaki
        </title>
      ...
      <g onClick={() => onPrefectureClick(44, '大分')} fill={isPrefectureSelected(44) ? '#3B82F6' : '#EEE'} data-code={44} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(163.000000, 771.000000)">
        <title>
          大分 / Oita
        </title>
      ...
      <g onClick={() => onPrefectureClick(43, '熊本')} fill={isPrefectureSelected(43) ? '#3B82F6' : '#EEE'} data-code={43} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(115.000000, 800.000000)">
        <title>
          熊本 / kumamoto
        </title>
      ...
      <g onClick={() => onPrefectureClick(42, '長崎')} fill={isPrefectureSelected(42) ? '#3B82F6' : '#EEE'} data-code={42} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(44.000000, 700.000000)">
        <title>
          長崎 / Nagasaki
        </title>
      ...
      <g onClick={() => onPrefectureClick(41, '佐賀')} fill={isPrefectureSelected(41) ? '#3B82F6' : '#EEE'} data-code={41} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(108.000000, 773.000000)">
        <title>
          佐賀 / Saga
        </title>
      ...
      <g onClick={() => onPrefectureClick(40, '福島')} fill={isPrefectureSelected(40) ? '#3B82F6' : '#EEE'} data-code={40} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(123.000000, 752.000000)">
        <title>
          福岡 / Fukuoka
        </title>
      ...
      <g onClick={() => onPrefectureClick(39, '高知')} fill={isPrefectureSelected(39) ? '#3B82F6' : '#EEE'} data-code={39} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(251.000000, 765.000000)">
        <title>
          高知 / Kochi
        </title>
      ...
      <g onClick={() => onPrefectureClick(38, '愛媛')} fill={isPrefectureSelected(38) ? '#3B82F6' : '#EEE'} data-code={38} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(225.000000, 737.000000)">
        <title>
          愛媛 / Ehime
        </title>
      ...
      <g onClick={() => onPrefectureClick(37, '香川')} fill={isPrefectureSelected(37) ? '#3B82F6' : '#EEE'} data-code={37} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(308.000000, 724.000000)">
        <title>
          香川 / Kagawa
        </title>
      ...
      <g onClick={() => onPrefectureClick(36, '徳島')} fill={isPrefectureSelected(36) ? '#3B82F6' : '#EEE'} data-code={36} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(312.000000, 744.000000)">
        <title>
          徳島 / Tokushima
        </title>
      ...
      <g onClick={() => onPrefectureClick(35, '山口')} fill={isPrefectureSelected(35) ? '#3B82F6' : '#EEE'} data-code={35} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(168.000000, 710.000000)">
        <title>
          山口 / Yamaguchi
        </title>
      ...
      <g onClick={() => onPrefectureClick(34, '広島')} fill={isPrefectureSelected(34) ? '#3B82F6' : '#EEE'} data-code={34} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(230.000000, 687.000000)">
        <title>
          広島 / Hiroshima
        </title>
      ...
      <g onClick={() => onPrefectureClick(33, '岡山')} fill={isPrefectureSelected(33) ? '#3B82F6' : '#EEE'} data-code={33} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(295.000000, 673.000000)">
        <title>
          岡山 / Okayama
        </title>
      ...
      <g onClick={() => onPrefectureClick(32, '島根')} fill={isPrefectureSelected(32) ? '#3B82F6' : '#EEE'} data-code={32} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(211.000000, 610.000000)">
        <title>
          島根 / Shimane
        </title>
      ...
      <g onClick={() => onPrefectureClick(31, '鳥取')} fill={isPrefectureSelected(31) ? '#3B82F6' : '#EEE'} data-code={31} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(288.000000, 658.000000)">
        <title>
          鳥取 / Tottori
        </title>
      ...
      <g onClick={() => onPrefectureClick(30, '和歌山')} fill={isPrefectureSelected(30) ? '#3B82F6' : '#EEE'} data-code={30} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(385.000000, 737.000000)">
        <title>
          和歌山 / Wakayama
        </title>
      ...
      <g onClick={() => onPrefectureClick(29, '奈良')} fill={isPrefectureSelected(29) ? '#3B82F6' : '#EEE'} data-code={29} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(410.000000, 712.000000)">
        <title>
          奈良 / Nara
        </title>
      ...
      <g  onClick={() => onPrefectureClick(28, '兵庫')} fill={isPrefectureSelected(28) ? '#3B82F6' : '#EEE'} data-code={28} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(345.000000, 655.000000)">
        <title>
          兵庫 / Hyogo
        </title>
      ...
      <g  onClick={() => onPrefectureClick(27, '大阪')} fill={isPrefectureSelected(27) ? '#3B82F6' : '#EEE'} data-code={27} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(387.000000, 695.000000)">
        <title>
          大阪 / Osaka
        </title>
      ...
      <g  onClick={() => onPrefectureClick(26, '京都')} fill={isPrefectureSelected(26) ? '#3B82F6' : '#EEE'} data-code={26} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(377.000000, 649.000000)">
        <title>
          京都 / Kyoto
        </title>
      ...
      <g  onClick={() => onPrefectureClick(25, '滋賀')} fill={isPrefectureSelected(25) ? '#3B82F6' : '#EEE'} data-code={25} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(423.000000, 655.000000)">
        <title>
          滋賀 / Shiga
        </title>
      ...
      <g onClick={() => onPrefectureClick(24, '三重')} fill={isPrefectureSelected(24) ? '#3B82F6' : '#EEE'} data-code={24} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(426.000000, 683.000000)">
        <title>
          三重 / Mie
        </title>
      ...
      <g  onClick={() => onPrefectureClick(23, '愛知')} fill={isPrefectureSelected(23) ? '#3B82F6' : '#EEE'} data-code={23} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(469.000000, 673.000000)">
        <title>
          愛知 / Aichi
        </title>
      ...
      <g onClick={() => onPrefectureClick(22, '静岡')} fill={isPrefectureSelected(22) ? '#3B82F6' : '#EEE'} data-code={22} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(511.000000, 659.000000)">
        <title>
          静岡 / Shizuoka
        </title>
      ...
      <g onClick={() => onPrefectureClick(21, '岐阜')} fill={isPrefectureSelected(21) ? '#3B82F6' : '#EEE'} data-code={21} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(450.000000, 608.000000)">
        <title>
          岐阜 / Gifu
        </title>
      ...
      <g onClick={() => onPrefectureClick(20, '長野')} fill={isPrefectureSelected(20) ? '#3B82F6' : '#EEE'} data-code={20} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(503.000000, 572.000000)">
        <title>
          長野 / Nagano
        </title>
      ...
      <g onClick={() => onPrefectureClick(19, '山梨')} fill={isPrefectureSelected(19) ? '#3B82F6' : '#EEE'} data-code={19} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(546.000000, 638.000000)">
        <title>
          山梨 / Yamanashi
        </title>
      ...
      <g onClick={() => onPrefectureClick(18, '福井')} fill={isPrefectureSelected(18) ? '#3B82F6' : '#EEE'} data-code={18} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(408.000000, 618.000000)">
        <title>
          福井 / Fukui
        </title>
      ...
      <g onClick={() => onPrefectureClick(17, '石川')} fill={isPrefectureSelected(17) ? '#3B82F6' : '#EEE'} data-code={17} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(448.000000, 541.000000)">
        <title>
          石川 / Ishikawa
        </title>
      ...
      <g onClick={() => onPrefectureClick(16, '富山')} fill={isPrefectureSelected(16) ? '#3B82F6' : '#EEE'} data-code={16} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(475.000000, 575.000000)">
        <title>
          富山 / Toyama
        </title>
      ...
      <g onClick={() => onPrefectureClick(15, '新潟')} fill={isPrefectureSelected(15) ? '#3B82F6' : '#EEE'} data-code={15} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(518.000000, 476.000000)">
        <title>
          新潟 / Niigata
        </title>
      ...
      <g onClick={() => onPrefectureClick(14, '神奈川')} fill={isPrefectureSelected(14) ? '#3B82F6' : '#EEE'} data-code={14} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(584.000000, 656.000000)">
        <title>
          神奈川 / Kanagawa
        </title>
      ...
      <g  onClick={() => onPrefectureClick(13, '東京')} fill={isPrefectureSelected(13) ? '#3B82F6' : '#EEE'} data-code={13} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(585.000000, 642.000000)">
        <title>
          東京 / Tokyo
        </title>
      ...
      <g  onClick={() => onPrefectureClick(12, '千葉')} fill={isPrefectureSelected(12) ? '#3B82F6' : '#EEE'} data-code={12} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(627.000000, 629.000000)">
        <title>
          千葉 / Chiba
        </title>
      ...
      <g onClick={() => onPrefectureClick(11, '埼玉')} fill={isPrefectureSelected(11) ? '#3B82F6' : '#EEE'} data-code={11} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(573.000000, 618.000000)">
        <title>
          埼玉 / Saitama
        </title>
      ...
      <g  onClick={() => onPrefectureClick(10, '群馬')} fill={isPrefectureSelected(10) ? '#3B82F6' : '#EEE'} data-code={10} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(557.000000, 570.000000)">
        <title>
          群馬 / Gunma
        </title>
      ...
      <g onClick={() => onPrefectureClick(9, '栃木')} fill={isPrefectureSelected(9) ? '#3B82F6' : '#EEE'} data-code={9} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(603.000000, 563.000000)">
        <title>
          栃木 / Tochigi
        </title>
      ...
      <g onClick={() => onPrefectureClick(8, '茨城')} fill={isPrefectureSelected(8) ? '#3B82F6' : '#EEE'} data-code={8} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(622.000000, 575.000000)">
        <title>
          茨城 / Ibaraki
        </title>
      ...
      <g onClick={() => onPrefectureClick(7, '福島')} fill={isPrefectureSelected(7) ? '#3B82F6' : '#EEE'} data-code={7} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(594.000000, 511.000000)">
        <title>
          福島 / Fukushima
        </title>
      ...
      <g onClick={() => onPrefectureClick(6, '山形')} fill={isPrefectureSelected(6) ? '#3B82F6' : '#EEE'} data-code={6} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(612.000000, 439.000000)">
        <title>
          山形 / Yamagata
        </title>
      ...
      <g onClick={() => onPrefectureClick(5, '秋田')} fill={isPrefectureSelected(5) ? '#3B82F6' : '#EEE'} data-code={5} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(617.000000, 352.000000)">
        <title>
          秋田 / Akita
        </title>
      ...
      <g onClick={() => onPrefectureClick(4, '宮城')} fill={isPrefectureSelected(4) ? '#3B82F6' : '#EEE'} data-code={4} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(648.000000, 445.000000)">
        <title>
          宮城 / Miyagi
        </title>
      ...
      <g onClick={() => onPrefectureClick(3, '岩手')} fill={isPrefectureSelected(3) ? '#3B82F6' : '#EEE'} data-code={3} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(664.000000, 354.000000)">
        <title>
          岩手 / Iwate
        </title>
      ...
      <g onClick={() => onPrefectureClick(2, '青森')} fill={isPrefectureSelected(2) ? '#3B82F6' : '#EEE'} data-code={2} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(624.000000, 287.000000)">
        <title>
          青森 / Aomori
        </title>
      ...
      <g onClick={() => onPrefectureClick(1, '北海道')} fill={isPrefectureSelected(1) ? '#3B82F6' : '#EEE'} data-code={1} strokeLinejoin="round" fillRule="nonzero" stroke="#000" strokeWidth={1.0} transform="translate(602.000000, 10.000000)">
        <title>
          北海道 / Hokkaido
        </title>
